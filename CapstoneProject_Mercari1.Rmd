...
```{r trainexp8, out.width="400px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/ItemPrice.png")
```
...
```{r trainexp10, out.width="400px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/ItemConditionCategory.png")
```
...
```{r trainexp12, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/ItemCorrelation.png")
```
...
Looking at the average price by condition shows a relationship that is not quite as neat as expected. Condition 5 clearly has the highest price, however condition 1 has the next-highest price, followed by condition 2, then 3, then 4.  Condition 5 is a bit of an anomaly in that it has the highest price. However, it also has the fewest number of items, so our point estimate has the most uncertainty.
  ...
  * Shipping
  The inital thought is that items where the shipping fee is paid by the seller will be higher-priced. However, there are a number of conflating factors. This may be true within specific product categories and item conditions, but not when comparing items on the aggregate. Let's see.
  
 
```{r trainexp13, eval = FALSE}
...
```{r trainexp14, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/PriceShipping.png")
```
...
```{r trainexp16, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/BrandName.png")
```
...
```{r trainexp20, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/CategoryName.png")
```
...
```{r trainexp23, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/PriceByTopLevelCat.png")
```
...
```{r trainexp25, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/PriceByLevel2Cat.png")
```

  * Feature Iteractions
  Now let us examine how item counts are distributed across top-level category and condition.

```{r trainexp26, eval=FALSE}
p1 <-
...
```{r trainexp27, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/FeatureInteraction.png")
```
...
```{r trainexp30, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/MostCommonDescWords.png")
```
...
```{r trainexp32, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/WordCloud1.png")
```
...
```{r trainexp34a, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/MostBiGram.png")
```

'Brand new' is the most comonly-occuring bigram follow by 'free shipping'. We can also make a word cloud of bigrams.


```{r trainexp33a, eval=FALSE}
set.seed(100)
...
```{r trainexp34, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/WordCloud2.png")
```

Let's repeat this process one more time, this time with 3-grams.


```{r trainexp35, eval=FALSE}
dfm3 <- dcorpus %>%
    corpus_sample(size = floor(ndoc(dcorpus) * 0.15)) %>%
    dfm(
        ngrams = 3,
...
```{r trainexp36, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/Most3Gram.png")
```
...
```{r trainexp38, out.width="600px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/WordCloud3.png")
```
...
```{r trainexp40, out.width="1200px", echo = FALSE}
knitr::include_graphics("c://Users/rsubra02/Documents/Mercari/Document/DocVar.png")
```
...
* Topic Modelling using Latent Dirichlet Allocation(LDA) model
  ...
  Topic Modelling provides an algorthmic solution to managing, organizing and annotating large texts. The annotations aid in tasks of information retrieval, classification and exploration. topic models are generative models which provide a probabilistic framework for the term frequency occurrences in documents. 
...
Using the topic to generate the word itself (according to the topic's multinomial distribution). For example, if we selected the food topic, we might generate the word "broccoli" with 30% probability, "bananas" with 15% probability, and so on.
  ...
  In this exercise LDA is used to identify the most frequently used words in each classification(Low, Mid, High, Higher, Highest). The number of occurances of words in each item description for every record in the data set for every classification is counted. The maximum number words based on classification is used to set the price classification as Low, Mid, High, Higher or Highest.  
```{r train4, eval=FALSE}
LDAFunc <- function(x){
...
head(submission,10)
   test_id    price log price
1    14824 13.21467  2.581327
2    14825 18.76460  2.931972
3    14825 18.76460  2.931972
4    14826 11.98122  2.483341
5    14826 11.98122  2.483341
6    14827 13.41127  2.596096
7    14827 13.41127  2.596096
8    14828 12.56228  2.530699
9    14828 12.56228  2.530699
10   14829 13.21467  2.581327
